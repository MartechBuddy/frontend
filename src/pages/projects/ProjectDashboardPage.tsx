    ...
    <div className="page-background min-h-screen">
      <div className="p-6 space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gradient">Project Dashboard</h1>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
              ...
              <span className="text-sm text-foreground">Site audit completed - 12 issues found</span>
              <span className="text-xs text-muted-foreground ml-auto">2 hours ago</span>
            </div>
            <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
              <FileText className="h-4 w-4 text-blue-500" />
              <span className="text-sm text-foreground">New blog post "SEO Best Practices" generated</span>
              <span className="text-xs text-muted-foreground ml-auto">1 day ago</span>
            </div>
            <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
              <Target className="h-4 w-4 text-purple-500" />
              <span className="text-sm text-foreground">Keyword cluster analysis completed</span>
